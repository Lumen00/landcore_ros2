...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/landcore_ros2/install/landdrive"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/landdrive/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/landdrive/environment/path.sh"
