...
class Cartesian_Subscriber(Node):
    ...
    def PID_control(self):
        ...
        pwm = [
            ...
            max(0, min(100, lb_factor/0.3 + self.Kp[2]*errors[2] + self.Ki[2]*self.I_error[2] + self.Kd[2]*self.D_error[2])), # Left Back     
            max(0, min(100, rb_factor/0.3 + self.Kp[3]*errors[3] + self.Ki[3]*self.I_error[3] + self.Kd[3]*self.D_error[3])) # Right Back    
        ] 
