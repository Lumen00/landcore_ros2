...
class Cartesian_Subscriber(Node):
    ...
    def PID_control(self):
        ...
        pwm = [
            max(0, min(80, lf_factor/0.275 + self.Kp[0]*errors[0] + self.Ki[0]*self.I_error[0] + self.Kd[0]*self.D_error[0])), # Left Front    
            max(0, min(80, rf_factor/0.275 + self.Kp[1]*errors[1] + self.Ki[1]*self.I_error[1] + self.Kd[1]*self.D_error[1])), # Right Front   
