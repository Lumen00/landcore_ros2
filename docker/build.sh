...
build_docker_image()
{
    ...
    LOG="Building Docker image landcore:latest ..."
    ...
    sudo docker image buildx build -f $SCRIPT_PATH/Dockerfile -t lumen00/landcore:latest $PARENT_PATH --platform linux/amd64,linux/arm64/v8 #--no-cache
}
